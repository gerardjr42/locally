          ...
          <div className="card bg-base-100 image-full w-full shadow-sm mb-4">
            ...
            <div className="card-body py-4 px-6">
              <div className="flex flex-row items-center justify-between w-full">
                <h2
                  className="text-md m hover:pointer-events-auto"
                ...
                <div className="card-body bg-transparent flex-col items-center justify-center p-2">
                  ...
                  {areUsersConfirmed && !didConnectionOccur && (
                    <div className="flex flex-col items-center justify-evenly w-full">
                      <Button
                        className=" bg-teal-500 text-white text-sm p-4 my-2 rounded-full font-semibold flex justify-evenly"
                      ...
                      <Button className=" bg-teal-500 text-white text-sm p-4 my-2 rounded-full font-semibold flex items-center justify-center">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
