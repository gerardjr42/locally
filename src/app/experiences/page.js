...
export default function AllExperiences() {
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-4">
        {experiences.map((experience) => (
          ...
          >
            ...
            <div className="card-body">
              ...
              <p className="text-sm text-gray-600">{experience.eventDate}</p>
              <p className="text-sm">{experience.eventLocation}</p>
              <p className="font-semibold">{experience.eventPrice}</p>
